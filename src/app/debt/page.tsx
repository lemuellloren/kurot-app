    ...
    <>
      <div className='p-3.5 space-y-3'>
        <HeroCard
          ...
          title="Track what you owe & what's owed"
        >
        ...
        {(tab === 'owe' ? owe : owed).length === 0 ? (
          <div className='card p-8 text-center'>
            ...
            <p className='text-sm text-green-700/50'>
              No {tab === 'owe' ? 'debts' : 'receivables'} tracked
            </p>
          </div>
        ) : (
        ...
        <div className='flex items-start gap-3 mb-3'>
          ...
          <div className='flex-1 min-w-0'>
            ...
            <p className='text-xs text-green-700/50 mt-1'>
              ...
              <span className='text-green-700/35'>
                remaining of {fp(d.totalAmount)}
              </span>
            </p>
          </div>
        ...
        <div className='border-t border-green-800/10 p-4 bg-green-50/60 space-y-3'>
          <div className='grid grid-cols-2 gap-3 text-xs'>
            {[
              ...
              {
                label: 'Total paid',
                value: fp(d.totalAmount - d.remainingAmount),
              },
          ...
          {d.notes && (
            <p className='text-xs text-green-700/55 italic'>
              &ldquo;{d.notes}&rdquo;
            </p>
          )}
          ...
          <div className='flex gap-2 pt-1'>
            {!settled && (
              ...
              >
                <DollarSign size={13} />{' '}
                {isOwe ? 'Record Payment' : 'Record Collection'}
              </button>
            )}
            <button
              onClick={onDelete}
      ...
      <div className='space-y-3'>
        <div>
          <label className='label'>
            {tab === 'owe' ? 'Creditor name' : 'Debtor name'}
          </label>
          <input
            className='input'
            placeholder={tab === 'owe' ? 'e.g. BDO Bank' : 'e.g. John Doe'}
            value={name}
        ...
        <div>
          ...
          <input
            className='input'
            placeholder='e.g. Monthly payment ₱5,000'
            value={notes}
    ...
    <Modal onClose={onClose}>
      ...
      <p className='text-sm text-green-700/60 mb-4'>
        ...
        <span className='text-green-700/40 ml-1'>
          · {fp(debt.remainingAmount)} remaining
        </span>
      </p>
      <div className='space-y-3'>
        <div>
